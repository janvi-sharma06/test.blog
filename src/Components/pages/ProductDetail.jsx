...
const ProductDetail = () => {
 ...
 <p className="review-count">{totalReviews.toLocaleString()} reviews</p>
 </div>
 ...
 <img src={review.ratingIcon} alt={review.name} className="review-avatar" />
 ...
 SpotRacers – Car Racing Game is requesting 16 permissions and is using 46 libraries.{" "}
 ...
 <p className="suggested-rating"><FaStar color="#FFD700" size={18} />{app.rating}</p>
 </div>
 ))}
 </div>
 </section>
